...

{
  ...
  "reference_number": "номер связанного документа (напр. номер договора, к которому относится УПД) или пустая строка",
  "reference_date": "дата связанного документа в формате ДД.ММ.ГГГГ или пустая строка",
...
- Если документ ссылается на другой (напр. 'к Договору №123 от 01.01.2024'), заполни reference_number='123' и reference_date='01.01.2024'
- amount — полная сумма как написано в документе, включая валюту
...
def check_suspicious(doc: dict, page_threshold: int = 5) -> tuple[bool, str]:
    """
...
async def analyze_file(
    ...
    async with semaphore:
        ...
        # Подозрительность
        threshold = file_info.get("suspicious_threshold", 5)
