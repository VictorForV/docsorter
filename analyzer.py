...
- is_multidoc=true если файл содержит НЕСКОЛЬКО разных документов подряд (например, договор + УПД + акт). Обычные многостраничные документы одного типа — это false.
